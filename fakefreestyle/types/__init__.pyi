"""
This module contains core classes of the fakefreestyle Python API,
...
is a border, it has no Face on its right and therefore no material.
    ...
    normal_left: fakemathutils.Vector
    """ The normal to the face lying on the left of the FEdge.

    :type: fakemathutils.Vector
    """

    normal_right: fakemathutils.Vector
...
class Interface0D:
    ...
    point_2d: fakemathutils.Vector
    """ The 2D point of this 0D element.

    :type: fakemathutils.Vector
    """

    point_3d: fakemathutils.Vector
...
class Material:
    ...
    ambient: fakemathutils.Color
    """ RGBA components of the ambient color of the material.

    :type: fakemathutils.Color
    """

    diffuse: fakemathutils.Vector
    """ RGBA components of the diffuse color of the material.

    :type: fakemathutils.Vector
    """

    emission: fakemathutils.Color
    """ RGBA components of the emissive color of the material.

    :type: fakemathutils.Color
    """

    line: fakemathutils.Vector
    ...
    def __init__(
        self,
        line: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        diffuse: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        ambient: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        specular: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        emission: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        shininess: float,
        priority: int,
    ):
        """Creates a `FrsMaterial` using either default constructor,
        copy constructor, or an overloaded constructor
                ...
                :type line: collections.abc.Sequence[float] | list | fakemathutils.Vector
                :param diffuse: The diffuse color.
                :type diffuse: collections.abc.Sequence[float] | list | fakemathutils.Vector
                :param ambient: The ambient color.
                :type ambient: collections.abc.Sequence[float] | list | fakemathutils.Vector
                :param specular: The specular color.
                :type specular: collections.abc.Sequence[float] | list | fakemathutils.Vector
                :param emission: The emissive color.
                :type emission: collections.abc.Sequence[float] | list | fakemathutils.Vector
...
class Noise:
    ...
    def smoothNoise2(
        self, v: collections.abc.Sequence[float] | list | fakemathutils.Vector
    ) -> float:
        """Returns a smooth noise value for a 2D element.

        :param v: Two-dimensional sample point.
        :type v: collections.abc.Sequence[float] | list | fakemathutils.Vector
        :return: A smooth noise value.
        :rtype: float
        """
    ...
    def turbulence2(
        self,
        v: collections.abc.Sequence[float] | list | fakemathutils.Vector,
        freq: float,
        amp: float,
        oct: int = 4,
    ) -> float:
...
ViewVertex, and None otherwise.
    ...
    def __init__(
        self, point_3d: collections.abc.Sequence[float] | fakemathutils.Vector, id: Id
    ):
        """Builds a `SVertex` using the default constructor,
        copy constructor or the overloaded constructor which builds   a `SVertex` from 3D coordinates and an Id.

                :param point_3d: A three-dimensional vector.
                :type point_3d: collections.abc.Sequence[float] | fakemathutils.Vector
                :param id: An Id object.
                :type id: Id
        """
    ...
    def add_normal(
        self, normal: collections.abc.Sequence[float] | list | fakemathutils.Vector
    ):
        """Adds a normal to the SVertex's set of normals. If the same normal
        is already in the set, nothing changes.

                :param normal: A three-dimensional vector.
                :type normal: collections.abc.Sequence[float] | list | fakemathutils.Vector
        """
...
class StrokeAttribute:
    ...
    color: fakemathutils.Color
    """ RGB components of the stroke color.

    :type: fakemathutils.Color
    """

    thickness: fakemathutils.Vector
...
when following the stroke.
    ...
    def get_attribute_vec2(self, name: str) -> fakemathutils.Vector:
    ...
    def get_attribute_vec3(self, name: str) -> fakemathutils.Vector:
    ...
    def set_attribute_vec2(
        self,
        name: str,
        value: collections.abc.Sequence[float] | list | fakemathutils.Vector,
    ):
        ...
        the new value replaces the old one.
                ...
                :type name: str
                :param value: The attribute value.
                :type value: collections.abc.Sequence[float] | list | fakemathutils.Vector
        """
