"""
This module contains helper functions used for fakefreestyle style module
writing.

fakefreestyle.utils.ContextFunctions.rst
...
def getCurrentScene() -> fakebpy.types.Scene:
    """Returns the current scene.

    :return: The current scene.
    :rtype: fakebpy.types.Scene
    """
...
def integrate(
    func: fakefreestyle.types.UnaryFunction0D,
    it: fakefreestyle.types.Interface0DIterator,
    it_end: fakefreestyle.types.Interface0DIterator,
    integration_type: fakefreestyle.types.IntegrationType,
) -> float:
    ...
    Interface0D.
        :type func: fakefreestyle.types.UnaryFunction0D
    ...
    elements of the 1D element.
        :type it_end: fakefreestyle.types.Interface0DIterator
