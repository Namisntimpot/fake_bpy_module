...
* fakefreestyle.types.UnaryFunction0DDouble
* fakefreestyle.types.UnaryFunction0DEdgeNature
* fakefreestyle.types.UnaryFunction0DFloat
* fakefreestyle.types.UnaryFunction0DId
* fakefreestyle.types.UnaryFunction0DMaterial
* fakefreestyle.types.UnaryFunction0DUnsigned
* fakefreestyle.types.UnaryFunction0DVec2f
* fakefreestyle.types.UnaryFunction0DVec3f
* fakefreestyle.types.UnaryFunction0DVectorViewShape
* fakefreestyle.types.UnaryFunction0DViewShape
* fakefreestyle.types.UnaryFunction1DDouble
* fakefreestyle.types.UnaryFunction1DEdgeNature
* fakefreestyle.types.UnaryFunction1DFloat
* fakefreestyle.types.UnaryFunction1DUnsigned
* fakefreestyle.types.UnaryFunction1DVec2f
* fakefreestyle.types.UnaryFunction1DVec3f
* fakefreestyle.types.UnaryFunction1DVectorViewShape
* fakefreestyle.types.UnaryFunction1DVoid
...
import fakefreestyle.types
import fakemathutils

class ChainingTimeStampF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVoid` > `ChainingTimeStampF1D`"""

    def __init__(self):
        """Builds a ChainingTimeStampF1D object."""

    def __call__(self, inter: fakefreestyle.types.Interface1D):
        """Sets the chaining time stamp of the Interface1D.

        :param inter: An Interface1D object.
        :type inter: fakefreestyle.types.Interface1D
        """

class Curvature2DAngleF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `Curvature2DAngleF0D`"""

    def __init__(self):
        """Builds a Curvature2DAngleF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns a real value giving the 2D curvature (as an angle) of the 1D
        element to which the `fakefreestyle.types.Interface0D` pointed by
        the Interface0DIterator belongs. The 2D curvature is evaluated at the
        Interface0D.

                :param it: An Interface0DIterator object.
                :type it: fakefreestyle.types.Interface0DIterator
...
class Curvature2DAngleF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `Curvature2DAngleF1D`"""

    def __init__(
        self, integration_type: fakefreestyle.types.IntegrationType = IntegrationType.MEAN
    ):
        """Builds a Curvature2DAngleF1D object.

                :param integration_type: The integration method used to compute a single value
        from a set of values.
                :type integration_type: fakefreestyle.types.IntegrationType
        """

    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
...
class CurveNatureF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DEdgeNature` > `CurveNatureF0D`"""

    def __init__(self):
        """Builds a CurveNatureF0D object."""

    def __call__(
        self, it: fakefreestyle.types.Interface0DIterator
    ) -> fakefreestyle.types.Nature:
        """Returns the `fakefreestyle.types.Nature` of the 1D element the
        ...
        belongs.
                :rtype: fakefreestyle.types.Nature
        """

class CurveNatureF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DEdgeNature` > `CurveNatureF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> fakefreestyle.types.Nature:
        """Returns the nature of the Interface1D (silhouette, ridge, crease, and
        so on). Except if the Interface1D is a
        `fakefreestyle.types.ViewEdge`, this result might be ambiguous.
...
class DensityF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `DensityF0D`"""
    ...
    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        ...
        `fakefreestyle.types.Interface0D` pointed by the
...
class DensityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `DensityF1D`"""

    def __init__(
        self,
        sigma: float = 2.0,
        integration_type: fakefreestyle.types.IntegrationType = IntegrationType.MEAN,
        sampling: float = 2.0,
    ):
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
        ...
        `fakefreestyle.functions.DensityF0D` functor) with a user-defined
...
class GetCompleteViewMapDensityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetCompleteViewMapDensityF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
        ...
        `fakefreestyle.functions.ReadCompleteViewMapPixelF0D` functor) and
...
class GetCurvilinearAbscissaF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `GetCurvilinearAbscissaF0D`"""
...
class GetDirectionalViewMapDensityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetDirectionalViewMapDensityF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
        ...
        `fakefreestyle.functions.ReadSteerableViewMapPixelF0D` functor) and
        then integrated into a single value using a user-defined integration
        method.
...
class GetOccludeeF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DViewShape` > `GetOccludeeF0D`"""
    ...
    def __call__(
        self, it: fakefreestyle.types.Interface0DIterator
    ) -> fakefreestyle.types.ViewShape:
        """Returns the `fakefreestyle.types.ViewShape` that the Interface0D
        pointed by the Interface0DIterator occludes.

                :param it: An Interface0DIterator object.
                :type it: fakefreestyle.types.Interface0DIterator
                :return: The ViewShape occluded by the pointed Interface0D.
                :rtype: fakefreestyle.types.ViewShape
        """

class GetOccludeeF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVectorViewShape` > `GetOccludeeF1D`"""
...
class GetOccludersF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DVectorViewShape` > `GetOccludersF0D`"""

    def __init__(self):
        """Builds a GetOccludersF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator):
        """Returns a list of `fakefreestyle.types.ViewShape` objects occluding the
        `fakefreestyle.types.Interface0D` pointed by the Interface0DIterator.
...
class GetOccludersF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVectorViewShape` > `GetOccludersF1D`"""
...
class GetParameterF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `GetParameterF0D`"""

    def __init__(self):
        """Builds a GetParameterF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the parameter of the `fakefreestyle.types.Interface0D`
...
class GetProjectedXF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetProjectedXF0D`"""

    def __init__(self):
        """Builds a GetProjectedXF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the X 3D projected coordinate of the `fakefreestyle.types.Interface0D`
...
class GetProjectedXF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetProjectedXF1D`"""
...
class GetProjectedYF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetProjectedYF0D`"""

    def __init__(self):
        """Builds a GetProjectedYF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the Y 3D projected coordinate of the `fakefreestyle.types.Interface0D`
        pointed by the Interface0DIterator.
...
class GetProjectedYF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetProjectedYF1D`"""
...
class GetProjectedZF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetProjectedZF0D`"""

    def __init__(self):
        """Builds a GetProjectedZF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the Z 3D projected coordinate of the `fakefreestyle.types.Interface0D`
        pointed by the Interface0DIterator.
...
class GetProjectedZF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetProjectedZF1D`"""
...
class GetShapeF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DViewShape` > `GetShapeF0D`"""
    ...
    def __call__(
        ...
        """Returns the `fakefreestyle.types.ViewShape` containing the
...
class GetShapeF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVectorViewShape` > `GetShapeF1D`"""
...
class GetSteerableViewMapDensityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetSteerableViewMapDensityF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
        ...
        density of each `fakefreestyle.types.FEdge` is evaluated in the
        proper steerable `fakefreestyle.types.ViewMap` depending on its
        orientation.
...
class GetViewMapGradientNormF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `GetViewMapGradientNormF0D`"""
...
class GetViewMapGradientNormF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetViewMapGradientNormF1D`"""
...
class GetXF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetXF0D`"""

    def __init__(self):
        """Builds a GetXF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the X 3D coordinate of the `fakefreestyle.types.Interface0D` pointed by
...
class GetXF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetXF1D`"""
...
class GetYF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetYF0D`"""

    def __init__(self):
        """Builds a GetYF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the Y 3D coordinate of the `fakefreestyle.types.Interface0D` pointed by
        the Interface0DIterator.
...
class GetYF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetYF1D`"""
...
class GetZF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `GetZF0D`"""

    def __init__(self):
        """Builds a GetZF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> float:
        """Returns the Z 3D coordinate of the `fakefreestyle.types.Interface0D` pointed by
        the Interface0DIterator.
...
class GetZF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `GetZF1D`"""
...
class IncrementChainingTimeStampF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVoid` > `IncrementChainingTimeStampF1D`"""
...
class LocalAverageDepthF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `LocalAverageDepthF0D`"""
...
class LocalAverageDepthF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `LocalAverageDepthF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> float:
        ...
        the `fakefreestyle.functions.LocalAverageDepthF0D` functor) with a
...
class MaterialF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DMaterial` > `MaterialF0D`"""
    ...
    def __call__(
        ...
        Interface0D.
                :rtype: fakefreestyle.types.Material
        """

class Normal2DF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DVec2f` > `Normal2DF0D`"""

    def __init__(self):
        """Builds a Normal2DF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> fakemathutils.Vector:
        """Returns a two-dimensional vector giving the normalized 2D normal to
        the 1D element to which the `fakefreestyle.types.Interface0D`
...
class Normal2DF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVec2f` > `Normal2DF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> fakemathutils.Vector:
...
class Orientation2DF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVec2f` > `Orientation2DF1D`"""
...
class Orientation3DF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVec3f` > `Orientation3DF1D`"""
...
class QuantitativeInvisibilityF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DUnsigned` > `QuantitativeInvisibilityF0D`"""

    def __init__(self):
        """Builds a QuantitativeInvisibilityF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> int:
        """Returns the quantitative invisibility of the
        `fakefreestyle.types.Interface0D` pointed by the
        Interface0DIterator. This evaluation can be ambiguous (in the case of
        a `fakefreestyle.types.TVertex` for example). This functor tries
...
class QuantitativeInvisibilityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DUnsigned` > `QuantitativeInvisibilityF1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> int:
        """Returns the Quantitative Invisibility of an Interface1D element. If
        the Interface1D is a `fakefreestyle.types.ViewEdge`, then there is
...
class ReadCompleteViewMapPixelF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `ReadCompleteViewMapPixelF0D`"""
...
class ReadMapPixelF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `ReadMapPixelF0D`"""
...
class ReadSteerableViewMapPixelF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DFloat` > `ReadSteerableViewMapPixelF0D`"""
...
class ShapeIdF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DId` > `ShapeIdF0D`"""

    def __init__(self):
        """Builds a ShapeIdF0D object."""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> fakefreestyle.types.Id:
        """Returns the `fakefreestyle.types.Id` of the Shape the
        `fakefreestyle.types.Interface0D` pointed by the
        Interface0DIterator belongs to. This evaluation can be ambiguous (in
        the case of a `fakefreestyle.types.TVertex` for example). This
        ...
        getShapeIdF0D functor.
                ...
                :rtype: fakefreestyle.types.Id
        """

class TimeStampF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DVoid` > `TimeStampF1D`"""
...
class VertexOrientation2DF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DVec2f` > `VertexOrientation2DF0D`"""
    ...
    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> fakemathutils.Vector:
        ...
        1D element to which the `fakefreestyle.types.Interface0D` pointed
...
class VertexOrientation3DF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DVec3f` > `VertexOrientation3DF0D`"""
...
class ZDiscontinuityF0D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction0D` > `fakefreestyle.types.UnaryFunction0DDouble` > `ZDiscontinuityF0D`"""
...
class ZDiscontinuityF1D:
    """Class hierarchy: `fakefreestyle.types.UnaryFunction1D` > `fakefreestyle.types.UnaryFunction1DDouble` > `ZDiscontinuityF1D`"""
