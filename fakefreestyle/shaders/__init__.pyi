...
fakefreestyle.types.StrokeShader class.
...
class BackboneStretcherShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `BackboneStretcherShader`[Geometry shader]"""
    ...
    def shade(self, stroke: fakefreestyle.types.Stroke):
        """Stretches the stroke at its two extremities and following the
        respective directions: v(1)v(0) and v(n-1)v(n).

                :param stroke: A Stroke object.
                :type stroke: fakefreestyle.types.Stroke
        """

class BezierCurveShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `BezierCurveShader`[Geometry shader]"""
...
class BlenderTextureShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `BlenderTextureShader`[Texture shader]"""
...
class CalligraphicShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `CalligraphicShader`[Thickness Shader]"""

    def __init__(
        self,
        thickness_min: float,
        thickness_max: float,
        orientation: collections.abc.Sequence[float] | fakemathutils.Vector,
        clamp: bool,
    ):
        ...
        perpendicular to the main direction.
                ...
                :type orientation: collections.abc.Sequence[float] | fakemathutils.Vector
...
class ColorNoiseShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `ColorNoiseShader`[Color shader]"""
...
class ConstantColorShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `ConstantColorShader`[Color shader]"""
...
class ConstantThicknessShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `ConstantThicknessShader`[Thickness shader]"""
...
class ConstrainedIncreasingThicknessShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `ConstrainedIncreasingThicknessShader`[Thickness shader]"""
...
class GuidingLinesShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `GuidingLinesShader`[Geometry shader]"""
...
class IncreasingColorShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `IncreasingColorShader`[Color shader]"""
...
class IncreasingThicknessShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `IncreasingThicknessShader`[Thickness shader]"""
...
class PolygonalizationShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `PolygonalizationShader`[Geometry shader]"""
...
class SamplingShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `SamplingShader`[Geometry shader]"""
...
class SmoothingShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `SmoothingShader`[Geometry shader]"""
...
class SpatialNoiseShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `SpatialNoiseShader`[Geometry shader]"""
...
class StrokeTextureStepShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `StrokeTextureStepShader`[Texture shader]"""
...
class ThicknessNoiseShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `ThicknessNoiseShader`[Thickness shader]"""
...
class TipRemoverShader:
    """Class hierarchy: `fakefreestyle.types.StrokeShader` > `TipRemoverShader`[Geometry shader]"""
