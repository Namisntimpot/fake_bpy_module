...
class ChainPredicateIterator:
    """Class hierarchy: `fakefreestyle.types.Iterator` >
    `fakefreestyle.types.ViewEdgeIterator` >
    `fakefreestyle.types.ChainingIterator` >
    ...
    def __init__(
        self,
        upred: fakefreestyle.types.UnaryPredicate1D,
        bpred: fakefreestyle.types.BinaryPredicate1D,
        restrict_to_selection: bool = True,
        restrict_to_unvisited: bool = True,
        begin: fakefreestyle.types.ViewEdge | None = None,
        ...
        predicate, a starting ViewEdge and its orientation or using the copy constructor.
                ...
                :type upred: fakefreestyle.types.UnaryPredicate1D
                :param bpred: The binary predicate that the next ViewEdge must
        satisfy together with the actual pointed ViewEdge.
                :type bpred: fakefreestyle.types.BinaryPredicate1D
        ...
        already been chained must be ignored ot not.
                ...
                :type begin: fakefreestyle.types.ViewEdge | None
