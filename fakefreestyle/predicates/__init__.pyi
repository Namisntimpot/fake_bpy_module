...
* fakefreestyle.types.BinaryPredicate0D
* fakefreestyle.types.BinaryPredicate1D
* fakefreestyle.types.UnaryPredicate0D
* fakefreestyle.types.UnaryPredicate1D
...
class ContourUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `ContourUP1D`"""

    def __call__(self, inter: fakefreestyle.types.Interface1D) -> bool:
...
class DensityLowerThanUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `DensityLowerThanUP1D`"""
    ...
    def __init__(self, threshold: float, sigma: float = 2.0):
        ...
        size used in the `fakefreestyle.functions.DensityF0D` functor.
                :type sigma: float
        """
...
class EqualToChainingTimeStampUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `fakefreestyle.types.EqualToChainingTimeStampUP1D`"""
...
class EqualToTimeStampUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `EqualToTimeStampUP1D`"""
...
class ExternalContourUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `ExternalContourUP1D`"""
...
class FalseBP1D:
    """Class hierarchy: `fakefreestyle.types.BinaryPredicate1D` > `FalseBP1D`"""

    def __call__(
        self, inter1: fakefreestyle.types.Interface1D, inter2: fakefreestyle.types.Interface1D
    ) -> bool:
        """Always returns false.

        :param inter1: The first Interface1D object.
        :type inter1: fakefreestyle.types.Interface1D
        :param inter2: The second Interface1D object.
        :type inter2: fakefreestyle.types.Interface1D
        :return: False.
        :rtype: bool
        """

class FalseUP0D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate0D` > `FalseUP0D`"""

    def __call__(self, it: fakefreestyle.types.Interface0DIterator) -> bool:
        """Always returns false.
...
class FalseUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `FalseUP1D`"""
...
class Length2DBP1D:
    """Class hierarchy: `fakefreestyle.types.BinaryPredicate1D` > `Length2DBP1D`"""
...
class QuantitativeInvisibilityUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `QuantitativeInvisibilityUP1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> bool:
        ...
        `fakefreestyle.functions.QuantitativeInvisibilityF1D` functor,
...
class SameShapeIdBP1D:
    """Class hierarchy: `fakefreestyle.types.BinaryPredicate1D` > `SameShapeIdBP1D`"""
...
class ShapeUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `ShapeUP1D`"""
    ...
    def __call__(self, inter: fakefreestyle.types.Interface1D) -> bool:
        ...
        same `fakefreestyle.types.Id` as the one specified by the user.
...
class TrueBP1D:
    """Class hierarchy: `fakefreestyle.types.BinaryPredicate1D` > `TrueBP1D`"""
...
class TrueUP0D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate0D` > `TrueUP0D`"""
...
class TrueUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `TrueUP1D`"""
...
class ViewMapGradientNormBP1D:
    """Class hierarchy: `fakefreestyle.types.BinaryPredicate1D` > `ViewMapGradientNormBP1D`"""
...
class WithinImageBoundaryUP1D:
    """Class hierarchy: `fakefreestyle.types.UnaryPredicate1D` > `WithinImageBoundaryUP1D`"""
