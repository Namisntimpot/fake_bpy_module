"""
This module gives access to low level fakebmesh operations.
...
```__/examples/fakebmesh.ops.1.py```
...
def average_vert_facedata(bm: fakebmesh.types.fakebmesh, verts: list[fakebmesh.types.BMVert] = []):
    """Average Vertices Face-vert Data.Merge uv/vcols associated with the input vertices at
    the bounding box center. (I know, it's not averaging but
    the vert_snap_to_bb_center is just too long).

        :param bm: The fakebmesh to operate on.
        :type bm: fakebmesh.types.fakebmesh
        :param verts: input vertices
        :type verts: list[fakebmesh.types.BMVert]
    """

def beautify_fill(
    bm: fakebmesh.types.fakebmesh,
    faces: list[fakebmesh.types.BMFace] = [],
    edges: list[fakebmesh.types.BMEdge] = [],
    ...
    """Beautify Fill.Rotate edges to create more evenly spaced triangles.
        ...
        :type faces: list[fakebmesh.types.BMFace]
        :param edges: edges that can be flipped
        :type edges: list[fakebmesh.types.BMEdge]
    ...
    type list of (`fakebmesh.types.BMVert`, `fakebmesh.types.BMEdge`, `fakebmesh.types.BMFace`)
        :rtype: dict[str, typing.Any]
    """

def bevel(
    bm: fakebmesh.types.fakebmesh,
    geom: list[fakebmesh.types.BMEdge]
    | list[fakebmesh.types.BMFace]
    | list[fakebmesh.types.BMVert] = [],
    offset: float = 0,
    ...
    spread: float = 0,
    custom_profile: fakebpy.types.bpy_struct | None = None,
    ...
    """Bevel.Bevels edges and vertices
        ...
        :type geom: list[fakebmesh.types.BMEdge] | list[fakebmesh.types.BMFace] | list[fakebmesh.types.BMVert]
        ...
        :type custom_profile: fakebpy.types.bpy_struct | None
    ...
    type list of (`fakebmesh.types.BMFace`)

    edges: output edges

    type list of (`fakebmesh.types.BMEdge`)

    verts: output verts

    type list of (`fakebmesh.types.BMVert`)
        :rtype: dict[str, typing.Any]
    """
...
def bisect_plane(
    ...
    | list[fakebmesh.types.BMVert] = [],
    dist: float = 0,
    plane_co: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    plane_no: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    ...
    """Bisect Plane.Bisects the mesh by a plane (cut the mesh in half).
        ...
        :type plane_co: collections.abc.Sequence[float] | fakemathutils.Vector
        :param plane_no: direction of the plane
        :type plane_no: collections.abc.Sequence[float] | fakemathutils.Vector
    ...
    type list of (`fakebmesh.types.BMVert`, `fakebmesh.types.BMEdge`)
...
def bmesh_to_mesh(
    bm: fakebmesh.types.fakebmesh, mesh: fakebpy.types.Mesh, object: fakebpy.types.Object
):
    """fakebmesh to Mesh.Converts a fakebmesh to a Mesh. This is reserved for exiting editmode.
    ...
    :type object: fakebpy.types.Object
    """
...
def collapse(
    bm: fakebmesh.types.fakebmesh, edges: list[fakebmesh.types.BMEdge] = [], uvs: bool = False
):
...
def collapse_uvs(bm: fakebmesh.types.fakebmesh, edges: list[fakebmesh.types.BMEdge] = []):
...
def connect_vert_pair(
    bm: fakebmesh.types.fakebmesh,
    verts: list[fakebmesh.types.BMVert] = [],
    verts_exclude: list[fakebmesh.types.BMVert] = [],
    faces_exclude: list[fakebmesh.types.BMFace] = [],
) -> dict[str, typing.Any]:
    """Connect Verts.Split faces by adding edges that connect verts.
        ...
        :type verts_exclude: list[fakebmesh.types.BMVert]
        :param faces_exclude: input faces to explicitly exclude from connecting
        :type faces_exclude: list[fakebmesh.types.BMFace]
        :return: edges:
...
def connect_verts_concave(
    bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = []
) -> dict[str, typing.Any]:
...
def connect_verts_nonplanar(
    bm: fakebmesh.types.fakebmesh, angle_limit: float = 0, faces: list[fakebmesh.types.BMFace] = []
) -> dict[str, typing.Any]:
...
def convex_hull(
    bm: fakebmesh.types.fakebmesh,
    input: list[fakebmesh.types.BMEdge]
    | list[fakebmesh.types.BMFace]
    | list[fakebmesh.types.BMVert] = [],
    ...
    that were in the input and are part of the hull.
        ...
        :type input: list[fakebmesh.types.BMEdge] | list[fakebmesh.types.BMFace] | list[fakebmesh.types.BMVert]
...
def create_circle(
    ...
    | fakemathutils.Matrix = fakemathutils.Matrix.Identity(4),
    calc_uvs: bool = False,
) -> dict[str, typing.Any]:
    """Creates a Circle.
        ...
        :type matrix: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
...
def create_vert(
    bm: fakebmesh.types.fakebmesh,
    co: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
) -> dict[str, typing.Any]:
    ...
    for click-create-vertex.
        ...
        :type co: collections.abc.Sequence[float] | fakemathutils.Vector
...
def dissolve_degenerate(
    bm: fakebmesh.types.fakebmesh, dist: float = 0, edges: list[fakebmesh.types.BMEdge] = []
):
...
def dissolve_faces(
    bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = [], use_verts: bool = False
) -> dict[str, typing.Any]:
    """Dissolve Faces.
...
def duplicate(
    ...
    | list[fakebmesh.types.BMFace]
    | list[fakebmesh.types.BMVert] = [],
    dest: fakebmesh.types.fakebmesh | None = None,
    ...
    optionally into a destination mesh.
        ...
        :param geom: input geometry
        :type geom: list[fakebmesh.types.BMEdge] | list[fakebmesh.types.BMFace] | list[fakebmesh.types.BMVert]
        :param dest: destination fakebmesh, if None will use current on
        :type dest: fakebmesh.types.fakebmesh | None
    ...
    type dict mapping vert/edge/face types to `fakebmesh.types.BMVert`/`fakebmesh.types.BMEdge`/`fakebmesh.types.BMFace`
...
def edgenet_prepare(
    bm: fakebmesh.types.fakebmesh, edges: list[fakebmesh.types.BMEdge] = []
) -> dict[str, typing.Any]:
...
def find_doubles(
    bm: fakebmesh.types.fakebmesh,
    verts: list[fakebmesh.types.BMVert] = [],
    keep_verts: list[fakebmesh.types.BMVert] = [],
    dist: float = 0,
) -> dict[str, typing.Any]:
    ...
    with vertices in that set.
        ...
        :type keep_verts: list[fakebmesh.types.BMVert]
...
def flip_quad_tessellation(bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = []):
...
def holes_fill(
    bm: fakebmesh.types.fakebmesh, edges: list[fakebmesh.types.BMEdge] = [], sides: int = 0
) -> dict[str, typing.Any]:
...
def mesh_to_bmesh(
    bm: fakebmesh.types.fakebmesh,
    mesh: fakebpy.types.Mesh,
    object: fakebpy.types.Object,
    use_shapekey: bool = False,
):
    """Mesh to fakebmesh.Load the contents of a mesh into the fakebmesh. this BMOP is private, it's
...
def object_load_bmesh(
    bm: fakebmesh.types.fakebmesh, scene: fakebpy.types.Scene, object: fakebpy.types.Object
):
    """Object Load fakebmesh.Loads a fakebmesh into an object/mesh. This is a "private"
    BMOP.
...
def pointmerge(
    bm: fakebmesh.types.fakebmesh,
    verts: list[fakebmesh.types.BMVert] = [],
    merge_co: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
):
    ...
    :type merge_co: collections.abc.Sequence[float] | fakemathutils.Vector
    """

def pointmerge_facedata(
    bm: fakebmesh.types.fakebmesh,
    verts: list[fakebmesh.types.BMVert] = [],
    vert_snap: fakebmesh.types.BMVert | None = None,
):
    ...
    :type vert_snap: fakebmesh.types.BMVert | None
    """
...
def recalc_face_normals(bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = []):
...
def remove_doubles(
    bm: fakebmesh.types.fakebmesh, verts: list[fakebmesh.types.BMVert] = [], dist: float = 0
):
...
def reverse_colors(
    bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = [], color_index: int = 0
):
...
def reverse_uvs(bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = []):
...
def rotate(
    bm: fakebmesh.types.fakebmesh,
    cent: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    matrix: collections.abc.Sequence[collections.abc.Sequence[float]]
    | fakemathutils.Matrix = fakemathutils.Matrix.Identity(4),
    verts: list[fakebmesh.types.BMVert] = [],
    ...
    :type cent: collections.abc.Sequence[float] | fakemathutils.Vector
    :param matrix: matrix defining rotation
    :type matrix: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
    :param verts: input vertices
    :type verts: list[fakebmesh.types.BMVert]
    :param space: matrix to define the space (typically object matrix)
    :type space: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
    :param use_shapekey: Transform shape keys too.
    :type use_shapekey: bool
    """
...
def rotate_edges(
    bm: fakebmesh.types.fakebmesh, edges: list[fakebmesh.types.BMEdge] = [], use_ccw: bool = False
) -> dict[str, typing.Any]:
...
def rotate_uvs(
    bm: fakebmesh.types.fakebmesh, faces: list[fakebmesh.types.BMFace] = [], use_ccw: bool = False
):
...
def scale(
    bm: fakebmesh.types.fakebmesh,
    vec: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    space: collections.abc.Sequence[collections.abc.Sequence[float]]
    | fakemathutils.Matrix = fakemathutils.Matrix.Identity(4),
    verts: list[fakebmesh.types.BMVert] = [],
    use_shapekey: bool = False,
    ...
    :type vec: collections.abc.Sequence[float] | fakemathutils.Vector
    :param space: matrix to define the space (typically object matrix)
    :type space: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
    :param verts: input vertices
    :type verts: list[fakebmesh.types.BMVert]
...
def spin(
    ...
    | list[fakebmesh.types.BMVert] = [],
    cent: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    axis: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    dvec: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
    angle: float = 0,
    space: collections.abc.Sequence[collections.abc.Sequence[float]]
    | fakemathutils.Matrix = fakemathutils.Matrix.Identity(4),
    steps: int = 0,
    ...
    rotating and possibly translating after each step
        ...
        :type axis: collections.abc.Sequence[float] | fakemathutils.Vector
        :param dvec: translation delta per step
        :type dvec: collections.abc.Sequence[float] | fakemathutils.Vector
...
def split(
    ...
    optionally into a destination mesh.
        ...
        :param geom: input geometry
        :type geom: list[fakebmesh.types.BMEdge] | list[fakebmesh.types.BMFace] | list[fakebmesh.types.BMVert]
        :param dest: destination fakebmesh, if None will use current one
        :type dest: fakebmesh.types.fakebmesh | None
...
def triangle_fill(
    ...
    edges: list[fakebmesh.types.BMEdge] = [],
    normal: collections.abc.Sequence[float] | fakemathutils.Vector = fakemathutils.Vector(),
) -> dict[str, typing.Any]:
    """Triangle Fill.Fill edges with triangles
        ...
        :type normal: collections.abc.Sequence[float] | fakemathutils.Vector
...
def unsubdivide(
    bm: fakebmesh.types.fakebmesh, verts: list[fakebmesh.types.BMVert] = [], iterations: int = 0
):
...
def weld_verts(bm: fakebmesh.types.fakebmesh, targetmap={}):
