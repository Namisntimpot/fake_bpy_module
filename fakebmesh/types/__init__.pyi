...
class BMEdge[_GenericType1]:
    """The fakebmesh edge connecting 2 verts"""
    ...
    def calc_tangent(self, loop: BMLoop) -> fakemathutils.Vector:
...
class BMElemSeq[_GenericType1]:
    ...
    `BMVert`, `BMEdge`, `BMFace`, `BMLoop`.When accessed via `fakebmesh.verts`, `fakebmesh.edges`, `fakebmesh.faces`
...
class BMFace[_GenericType1]:
    """The fakebmesh face with 3 or more sides"""
    ...
    normal: fakemathutils.Vector
    """ The normal for this face as a 3D, wrapped vector.

    :type: fakemathutils.Vector
    """
    ...
    def calc_center_bounds(self) -> fakemathutils.Vector:
    ...
    def calc_center_median(self) -> fakemathutils.Vector:
    ...
    def calc_center_median_weighted(self) -> fakemathutils.Vector:
    ...
    def calc_tangent_edge(self) -> fakemathutils.Vector:
    ...
    def calc_tangent_edge_diagonal(self) -> fakemathutils.Vector:
    ...
    def calc_tangent_edge_pair(self) -> fakemathutils.Vector:
    ...
    def calc_tangent_vert_diagonal(self) -> fakemathutils.Vector:
...
class BMIter[_GenericType1]:
    """Internal fakebmesh type for looping over verts/faces/edges,
...
class BMLayerAccessEdge:
    ...
    fakefreestyle: BMLayerCollection
    """ Accessor for fakefreestyle edge layer.
...
class BMLayerAccessFace:
    ...
    fakefreestyle: BMLayerCollection
    """ Accessor for fakefreestyle face layer.
...
class BMLoop[_GenericType1]:
    ...
    def calc_normal(self) -> fakemathutils.Vector:
    ...
    def calc_tangent(self) -> fakemathutils.Vector:
...
class BMVert[_GenericType1]:
    """The fakebmesh vertex type"""

    co: fakemathutils.Vector
...
class BMVertSeq:
    ...
    def new(
        self,
        co: collections.abc.Sequence[float] | fakemathutils.Vector = (0.0, 0.0, 0.0),
...
class fakebmesh:
    ...
    is_wrapped: bool
    """ True when this mesh is owned by blender (typically the editmode fakebmesh).
    ...
    def copy(self) -> typing_extensions.Self:
        ...
        :return: A copy of this fakebmesh.
        :rtype: typing_extensions.Self
        """

    def free(self):
        """Explicitly free the fakebmesh data from memory, causing exceptions on further access."""
    ...
    def from_mesh(
        ...
        """Initialize this fakebmesh from existing mesh datablock.
    ...
    def from_object(
        ...
        depsgraph: fakebpy.types.Depsgraph,
        cage: bool = False,
        face_normals: bool = True,
        vertex_normals: bool = True,
    ):
        """Initialize this fakebmesh from existing object data-block (only meshes are currently supported).

        :param object: The object data to load.
        :type object: fakebpy.types.Object
        :param depsgraph:
        :type depsgraph: fakebpy.types.Depsgraph
    ...
    def select_flush_mode(self):
        """flush selection based on the current mode current `fakebmesh.select_mode`."""

    def to_mesh(self, mesh: fakebpy.types.Mesh):
        """Writes this fakebmesh data into an existing Mesh datablock.
