...
def axis_conversion_ensure(
    operator: fakebpy.types.Operator, forward_attr: str, up_attr: str
) -> bool:
    """Function to ensure an operator has valid axis conversion settings, intended
    to be used from `fakebpy.types.Operator.check`.
...
def create_derived_objects(
    depsgraph: fakebpy.types.Depsgraph, objects: list[fakebpy.types.Object]
) -> dict:
    """This function takes a sequence of objects, returning their instances.
        ...
        :type objects: list[fakebpy.types.Object]
        :return: A dictionary where each key is an object from objects,
    values are lists of (`fakebpy.types.Object`, `fakemathutils.Matrix`) tuples representing instances.
        :rtype: dict
    """
...
def path_reference(
    ...
    library: fakebpy.types.Library | None = None,
) -> str:
    ...
    pass to path_reference_copy when exporting is done.
        ...
        :type library: fakebpy.types.Library | None
