...
def mesh_linked_triangles(mesh: fakebpy.types.Mesh) -> list:
...
def mesh_linked_uv_islands(mesh: fakebpy.types.Mesh) -> list:
...
def ngon_tessellate(
    from_data: fakebpy.types.Mesh | list,
    indices: list,
    fix_loops: bool = True,
    debug_print=True,
):
    ...
    ngon to create from existing verts.
        ...
        :type from_data: fakebpy.types.Mesh | list
...
def triangle_random_points(
    num_points, loop_triangles: fakebpy.types.MeshLoopTriangle | collections.abc.Sequence
) -> list:
    ...
    :type loop_triangles: fakebpy.types.MeshLoopTriangle | collections.abc.Sequence
