...
def bake_action(
    obj: fakebpy.types.Object, *, action: fakebpy.types.Action | None, frames, bake_options
) -> fakebpy.types.Action:
    """
    ...
    to be created.
        :type action: fakebpy.types.Action | None
        :param frames: Frames to bake.
        :return: an action or None
        :rtype: fakebpy.types.Action
    """

def bake_action_iter(
    obj: fakebpy.types.Object, *, action: fakebpy.types.Action | None, bake_options
) -> fakebpy.types.Action:
