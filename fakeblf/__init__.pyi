...
Example of using the fakeblf module. For this module to work we
need to use the OpenGL wrapper ~fakebgl as well.
...
def aspect(fontid: int, aspect: float):
    ...
    :param fontid: The id of the typeface as returned by `fakeblf.load`, for default font use 0.
    :type fontid: int
