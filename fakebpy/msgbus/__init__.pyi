...
def publish_rna(key):
    ...
    Arguments include
    - `fakebpy.types.Property` instance.
    - `fakebpy.types.Struct` type.
    - (`fakebpy.types.Struct`, str) type and property name.
    """
...
def subscribe_rna(key, owner: typing.Any | None, args, notify, options=set()):
    ...
    loaded, or can be cleared explicitly via `fakebpy.msgbus.clear_by_owner`.
