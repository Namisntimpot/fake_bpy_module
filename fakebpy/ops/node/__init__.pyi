...
def add_node(
    ...
    *,
    ...
    settings: fakebpy.types.bpy_prop_collection[fakebl_operators.node.NodeSetting]
    | None = None,
    type: str = "",
):
    ...
    :type settings: fakebpy.types.bpy_prop_collection[fakebl_operators.node.NodeSetting] | None
