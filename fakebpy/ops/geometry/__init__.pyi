...
def attribute_add(
    ...
    *,
    name: str = "",
    domain: fakebpy.typing.AttributeDomainItems | None = "POINT",
    data_type: fakebpy.typing.AttributeTypeItems | None = "FLOAT",
):
    ...
    :type domain: fakebpy.typing.AttributeDomainItems | None
    :param data_type: Data Type, Type of data stored in attribute
    :type data_type: fakebpy.typing.AttributeTypeItems | None
    """
