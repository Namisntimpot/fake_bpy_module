...
def add(
    ...
    *,
    ...
    type: fakebpy.typing.ObjectTypeItems | None = "EMPTY",
    enter_editmode: bool | None = False,
    align: typing.Literal["WORLD", "VIEW", "CURSOR"] | None = "WORLD",
    location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
        0.0,
    ),
    rotation: collections.abc.Sequence[float] | fakemathutils.Euler | None = (
        0.0,
        0.0,
        0.0,
    ),
    scale: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
):
    """Add an object to the scene
        ...
        :param type: Type
        :type type: fakebpy.typing.ObjectTypeItems | None
    ...
    3D Cursor -- Use the 3D cursor orientation for the new object.
        ...
        :type location: collections.abc.Sequence[float] | fakemathutils.Vector | None
        :param rotation: Rotation, Rotation for the newly added object
        :type rotation: collections.abc.Sequence[float] | fakemathutils.Euler | None
        :param scale: Scale, Scale for the newly added object
        :type scale: collections.abc.Sequence[float] | fakemathutils.Vector | None
    """
...
def add_named(
    ...
    *,
    ...
    :param matrix: Matrix
    :type matrix: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix | None
...
def bake(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.BakePassTypeItems | None = "COMBINED",
    pass_filter: set[fakebpy.typing.BakePassFilterTypeItems] | None = {},
    filepath: str = "",
    width: int | None = 512,
    height: int | None = 512,
    margin: int | None = 16,
    margin_type: fakebpy.typing.BakeMarginTypeItems | None = "EXTEND",
    use_selected_to_active: bool | None = False,
    max_ray_distance: float | None = 0.0,
    cage_extrusion: float | None = 0.0,
    cage_object: str = "",
    normal_space: fakebpy.typing.NormalSpaceItems | None = "TANGENT",
    normal_r: fakebpy.typing.NormalSwizzleItems | None = "POS_X",
    normal_g: fakebpy.typing.NormalSwizzleItems | None = "POS_Y",
    normal_b: fakebpy.typing.NormalSwizzleItems | None = "POS_Z",
    target: fakebpy.typing.BakeTargetItems | None = "IMAGE_TEXTURES",
    save_mode: fakebpy.typing.BakeSaveModeItems | None = "INTERNAL",
    ...
    :type type: fakebpy.typing.BakePassTypeItems | None
    :param pass_filter: Pass Filter, Filter to combined, diffuse, glossy, transmission and subsurface passes
    :type pass_filter: set[fakebpy.typing.BakePassFilterTypeItems] | None
    ...
    :type margin_type: fakebpy.typing.BakeMarginTypeItems | None
    ...
    :type normal_space: fakebpy.typing.NormalSpaceItems | None
    :param normal_r: R, Axis to bake in red channel
    :type normal_r: fakebpy.typing.NormalSwizzleItems | None
    :param normal_g: G, Axis to bake in green channel
    :type normal_g: fakebpy.typing.NormalSwizzleItems | None
    :param normal_b: B, Axis to bake in blue channel
    :type normal_b: fakebpy.typing.NormalSwizzleItems | None
    :param target: Target, Where to output the baked map
    :type target: fakebpy.typing.BakeTargetItems | None
    :param save_mode: Save Mode, Where to save baked image textures
    :type save_mode: fakebpy.typing.BakeSaveModeItems | None
...
def data_instance_add(
    ...
    *,
    name: str = "",
    session_uid: int | None = 0,
    type: fakebpy.typing.IdTypeItems | None = "ACTION",
    align: typing.Literal["WORLD", "VIEW", "CURSOR"] | None = "WORLD",
    location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
    ...
    """Add an object data instance
        ...
        :type session_uid: int | None
        :param type: Type
        :type type: fakebpy.typing.IdTypeItems | None
        :param align: Align, The alignment of the new object
...
def data_transfer(
    ...
    *,
    ...
    vert_mapping: fakebpy.typing.DtMethodVertexItems | None = "NEAREST",
    edge_mapping: fakebpy.typing.DtMethodEdgeItems | None = "NEAREST",
    loop_mapping: fakebpy.typing.DtMethodLoopItems | None = "NEAREST_POLYNOR",
    poly_mapping: fakebpy.typing.DtMethodPolyItems | None = "NEAREST",
    ...
    layers_select_src: fakebpy.typing.DtLayersSelectSrcItems | None = "ACTIVE",
    layers_select_dst: fakebpy.typing.DtLayersSelectDstItems | None = "ACTIVE",
    mix_mode: fakebpy.typing.DtMixModeItems | None = "REPLACE",
    ...
    FREESTYLE_EDGE
    fakefreestyle Mark -- Transfer fakefreestyle edge mark.
    ...
    FREESTYLE_FACE
    fakefreestyle Mark -- Transfer fakefreestyle face mark.
        ...
        :type layers_select_src: fakebpy.typing.DtLayersSelectSrcItems | None
        :param layers_select_dst: Destination Layers Matching, How to match source and destination layers
        :type layers_select_dst: fakebpy.typing.DtLayersSelectDstItems | None
        :param mix_mode: Mix Mode, How to affect destination elements with source values
        :type mix_mode: fakebpy.typing.DtMixModeItems | None
...
def duplicate(
    ...
    *,
    linked: bool | None = False,
    mode: fakebpy.typing.TransformModeTypeItems | None = "TRANSLATION",
):
    ...
    :type linked: bool | None
    :param mode: Mode
    :type mode: fakebpy.typing.TransformModeTypeItems | None
    """
...
def duplicate_move(
    ...
    *,
    ...
    TRANSFORM_OT_translate: fakebpy.ops.transform.translate | None = None,
):
    ...
    :type TRANSFORM_OT_translate: fakebpy.ops.transform.translate | None
    """
...
def empty_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ObjectEmptyDrawtypeItems | None = "PLAIN_AXES",
    radius: float | None = 1.0,
    align: typing.Literal["WORLD", "VIEW", "CURSOR"] | None = "WORLD",
    location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
    ...
    """Add an empty object to the scene
        ...
        :type undo: bool | None
        :param type: Type
        :type type: fakebpy.typing.ObjectEmptyDrawtypeItems | None
        :param radius: Radius
        :type radius: float | None
        :param align: Align, The alignment of the new object
...
def gpencil_add(
    ...
    *,
    ...
    scale: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
    type: fakebpy.typing.ObjectGpencilTypeItems | None = "EMPTY",
    ...
    3D Cursor -- Use the 3D cursor orientation for the new object.
        ...
        :type scale: collections.abc.Sequence[float] | fakemathutils.Vector | None
        :param type: Type
        :type type: fakebpy.typing.ObjectGpencilTypeItems | None
...
def gpencil_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ObjectGreasepencilModifierTypeItems | None = "GP_THICK",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.ObjectGreasepencilModifierTypeItems | None
    """
...
def light_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.LightTypeItems | None = "POINT",
    radius: float | None = 1.0,
    align: typing.Literal["WORLD", "VIEW", "CURSOR"] | None = "WORLD",
    location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
    ...
    """Add a light object to the scene
        ...
        :type undo: bool | None
        :param type: Type
        :type type: fakebpy.typing.LightTypeItems | None
        :param radius: Radius
        :type radius: float | None
        :param align: Align, The alignment of the new object
...
def metaball_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.MetaelemTypeItems | None = "BALL",
    ...
    """Add an metaball object to the scene
        ...
        :type type: fakebpy.typing.MetaelemTypeItems | None
        :param radius: Radius
        :type radius: float | None
        :param enter_editmode: Enter Edit Mode, Enter edit mode when adding this object
        :type enter_editmode: bool | None
...
def mode_set(
    ...
    undo: bool | None = None,
    *,
    mode: fakebpy.typing.ObjectModeItems | None = "OBJECT",
    toggle: bool | None = False,
):
    ...
    :type undo: bool | None
    :param mode: Mode
    :type mode: fakebpy.typing.ObjectModeItems | None
    :param toggle: Toggle
    :type toggle: bool | None
    """
...
def mode_set_with_submode(
    ...
    *,
    mode: fakebpy.typing.ObjectModeItems | None = "OBJECT",
    toggle: bool | None = False,
    mesh_select_mode: set[fakebpy.typing.MeshSelectModeItems] | None = {},
):
    """Sets the object interaction mode
    ...
    :type mesh_select_mode: set[fakebpy.typing.MeshSelectModeItems] | None
    """
...
def modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ObjectModifierTypeItems | None = "SUBSURF",
    use_selected_objects: bool | None = False,
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.ObjectModifierTypeItems | None
    :param use_selected_objects: Selected Objects, Affect all selected objects instead of just the active object
    :type use_selected_objects: bool | None
    """
...
def modifier_add_node_group(
    ...
    undo: bool | None = None,
    *,
    asset_library_type: fakebpy.typing.AssetLibraryTypeItems | None = "LOCAL",
    ...
    :type asset_library_type: fakebpy.typing.AssetLibraryTypeItems | None
...
def paths_calculate(
    ...
    undo: bool | None = None,
    *,
    display_type: fakebpy.typing.MotionpathDisplayTypeItems | None = "RANGE",
    range: fakebpy.typing.MotionpathRangeItems | None = "SCENE",
):
    ...
    :type undo: bool | None
    :param display_type: Display type
    :type display_type: fakebpy.typing.MotionpathDisplayTypeItems | None
    :param range: Computation Range
    :type range: fakebpy.typing.MotionpathRangeItems | None
    """
...
def randomize_transform(
    ...
    *,
    ...
    loc: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
    use_rot: bool | None = True,
    rot: collections.abc.Sequence[float] | fakemathutils.Euler | None = (0.0, 0.0, 0.0),
    ...
    :type loc: collections.abc.Sequence[float] | fakemathutils.Vector | None
    ...
    :type rot: collections.abc.Sequence[float] | fakemathutils.Euler | None
...
def select_by_type(
    ...
    *,
    extend: bool | None = False,
    type: fakebpy.typing.ObjectTypeItems | None = "MESH",
):
...
def shaderfx_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ObjectShaderfxTypeItems | None = "FX_BLUR",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.ObjectShaderfxTypeItems | None
    """
...
def volume_import(
    ...
    *,
    filepath: str = "",
    directory: str = "",
    files: fakebpy.types.bpy_prop_collection[fakebpy.types.OperatorFileListElement]
    | None = None,
    hide_props_region: bool | None = True,
    check_existing: bool | None = False,
    filter_blender: bool | None = False,
    ...
    """Import OpenVDB volume file
        ...
        :type directory: str
        :param files: Files
        :type files: fakebpy.types.bpy_prop_collection[fakebpy.types.OperatorFileListElement] | None
        :param hide_props_region: Hide Operator Properties, Collapse the region displaying the operator settings
        :type hide_props_region: bool | None
        :param check_existing: Check Existing, Check and warn on overwriting existing files
        :type check_existing: bool | None
