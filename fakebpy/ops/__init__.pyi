...
```
fakebpy.ops.test.operator(execution_context, undo)
```
...
member names in fakebpy.context.
For example to override fakebpy.context.active_object

,
you would pass {'active_object': object}

 to fakebpy.types.Context.temp_override.
