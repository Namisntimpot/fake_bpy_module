...
def unpack(
    ...
    undo: bool | None = None,
    *,
    method: fakebpy.typing.UnpackMethodItems | None = "USE_LOCAL",
    id: str = "",
):
    ...
    :type method: fakebpy.typing.UnpackMethodItems | None
...
def view_pan(
    ...
    undo: bool | None = None,
    *,
    offset: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0),
):
    """Pan the view
...
def view_zoom_in(
    ...
    undo: bool | None = None,
    *,
    location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0),
):
