...
def gltf(
    ...
    *,
    ...
    Crop -- Keep only frames above frame 0.
        ...
        :param export_gpu_instances: fakegpu Instances, Export using EXT_mesh_gpu_instancing. Limited to children of a given Empty. Multiple materials might be omitted
