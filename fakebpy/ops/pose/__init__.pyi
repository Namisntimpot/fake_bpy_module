...
def constraint_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ConstraintTypeItems | None = "",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.ConstraintTypeItems | None
    """
...
def paths_calculate(
    ...
    *,
    ...
    bake_location: fakebpy.typing.MotionpathBakeLocationItems | None = "HEADS",
):
    ...
    :type bake_location: fakebpy.typing.MotionpathBakeLocationItems | None
    """
...
def rotation_mode_set(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.ObjectRotationModeItems | None = "QUATERNION",
):
    ...
    :type type: fakebpy.typing.ObjectRotationModeItems | None
    """
