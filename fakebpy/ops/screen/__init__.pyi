...
def region_toggle(
    ...
    undo: bool | None = None,
    *,
    region_type: fakebpy.typing.RegionTypeItems | None = "WINDOW",
):
    ...
    :type region_type: fakebpy.typing.RegionTypeItems | None
    """
...
def space_type_set_or_cycle(
    ...
    undo: bool | None = None,
    *,
    space_type: fakebpy.typing.SpaceTypeItems | None = "EMPTY",
):
    ...
    :type space_type: fakebpy.typing.SpaceTypeItems | None
    """
...
def userpref_show(
    ...
    undo: bool | None = None,
    *,
    section: fakebpy.typing.PreferenceSectionItems | None = "INTERFACE",
):
    ...
    :type section: fakebpy.typing.PreferenceSectionItems | None
    """
