...
def duplicate_move(
    ...
    *,
    ...
    TRANSFORM_OT_transform: fakebpy.ops.transform.transform | None = None,
):
    ...
    :type TRANSFORM_OT_transform: fakebpy.ops.transform.transform | None
    """
...
def keyframe_type(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.BeztripleKeyframeTypeItems | None = "KEYFRAME",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.BeztripleKeyframeTypeItems | None
    """
