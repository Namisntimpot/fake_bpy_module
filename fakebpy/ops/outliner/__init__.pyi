...
def collection_color_tag_set(
    ...
    undo: bool | None = None,
    *,
    color: fakebpy.typing.CollectionColorItems | None = "NONE",
):
    ...
    :type color: fakebpy.typing.CollectionColorItems | None
    """
...
def id_remap(
    ...
    undo: bool | None = None,
    *,
    id_type: fakebpy.typing.IdTypeItems | None = "OBJECT",
    old_id: str | None = "",
    new_id: str | None = "",
):
    """Undocumented, consider contributing.
    ...
    :type id_type: fakebpy.typing.IdTypeItems | None
