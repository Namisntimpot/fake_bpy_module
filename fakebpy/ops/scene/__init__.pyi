...
def freestyle_add_edge_marks_to_keying_set(
    ...
    """Add the data paths to the fakefreestyle Edge Mark property of selected edges to the active keying set
...
def freestyle_add_face_marks_to_keying_set(
    ...
    """Add the data paths to the fakefreestyle Face Mark property of selected polygons to the active keying set
...
def freestyle_alpha_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.LinestyleAlphaModifierTypeItems | None = "ALONG_STROKE",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.LinestyleAlphaModifierTypeItems | None
    """
...
def freestyle_color_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.LinestyleColorModifierTypeItems | None = "ALONG_STROKE",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.LinestyleColorModifierTypeItems | None
    """
...
def freestyle_geometry_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.LinestyleGeometryModifierTypeItems | None = "2D_OFFSET",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.LinestyleGeometryModifierTypeItems | None
    """
...
def freestyle_stroke_material_create(
    ...
    """Create fakefreestyle stroke material for testing
...
def freestyle_thickness_modifier_add(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.LinestyleThicknessModifierTypeItems | None = "ALONG_STROKE",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.LinestyleThicknessModifierTypeItems | None
    """
