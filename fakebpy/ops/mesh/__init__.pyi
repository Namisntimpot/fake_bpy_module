...
def bisect(
    ...
    undo: bool | None = None,
    *,
    plane_co: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
        0.0,
    ),
    plane_no: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
        0.0,
    ),
    ...
    :type plane_co: collections.abc.Sequence[float] | fakemathutils.Vector | None
    :param plane_no: Plane Normal, The direction the plane points
    :type plane_no: collections.abc.Sequence[float] | fakemathutils.Vector | None
...
def bridge_edge_loops(
    ...
    *,
    ...
    profile_shape: fakebpy.typing.ProportionalFalloffCurveOnlyItems | None = "SMOOTH",
):
    ...
    :type profile_shape: fakebpy.typing.ProportionalFalloffCurveOnlyItems | None
    """
...
def decimate(
    ...
    *,
    ...
    symmetry_axis: fakebpy.typing.AxisXyzItems | None = "Y",
):
    ...
    :type symmetry_axis: fakebpy.typing.AxisXyzItems | None
    """
...
def dissolve_limited(
    ...
    *,
    ...
    delimit: set[fakebpy.typing.MeshDelimitModeItems] | None = {"NORMAL"},
):
    ...
    :type delimit: set[fakebpy.typing.MeshDelimitModeItems] | None
    """
...
def extrude_faces_move(
    ...
    *,
    ...
    TRANSFORM_OT_shrink_fatten: fakebpy.ops.transform.shrink_fatten | None = None,
):
    ...
    :type TRANSFORM_OT_shrink_fatten: fakebpy.ops.transform.shrink_fatten | None
    """
...
def extrude_repeat(
    ...
    *,
    steps: int | None = 10,
    offset: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
    ...
    :type offset: collections.abc.Sequence[float] | fakemathutils.Vector | None
...
def loopcut(
    ...
    *,
    ...
    falloff: fakebpy.typing.ProportionalFalloffCurveOnlyItems | None = "INVERSE_SQUARE",
    ...
    :type falloff: fakebpy.typing.ProportionalFalloffCurveOnlyItems | None
...
def loopcut_slide(
    ...
    *,
    ...
    TRANSFORM_OT_edge_slide: fakebpy.ops.transform.edge_slide | None = None,
):
    ...
    :type TRANSFORM_OT_edge_slide: fakebpy.ops.transform.edge_slide | None
    """
...
def mark_freestyle_edge(
    ...
    *,
    ...
    """(Un)mark selected edges as fakefreestyle feature edges
...
def mark_freestyle_face(
    ...
    *,
    ...
    """(Un)mark selected faces for exclusion from fakefreestyle feature edge detection
...
def point_normals(
    ...
    *,
    ...
    target_location: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
        0.0,
    ),
    ...
    Mouse -- Follow mouse cursor.
        ...
        :type target_location: collections.abc.Sequence[float] | fakemathutils.Vector | None
...
def polybuild_delete_at_cursor(
    ...
    *,
    ...
    proportional_edit_falloff: fakebpy.typing.ProportionalFalloffItems | None = "SMOOTH",
    ...
    :type proportional_edit_falloff: fakebpy.typing.ProportionalFalloffItems | None
...
def quads_convert_to_tris(
    ...
    undo: bool | None = None,
    *,
    quad_method: fakebpy.typing.ModifierTriangulateQuadMethodItems | None = "BEAUTY",
    ngon_method: fakebpy.typing.ModifierTriangulateNgonMethodItems | None = "BEAUTY",
):
    ...
    :type quad_method: fakebpy.typing.ModifierTriangulateQuadMethodItems | None
    :param ngon_method: N-gon Method, Method for splitting the n-gons into triangles
    :type ngon_method: fakebpy.typing.ModifierTriangulateNgonMethodItems | None
    """
...
def screw(
    ...
    *,
    steps: int | None = 9,
    turns: int | None = 1,
    center: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
    axis: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, 0.0),
):
    ...
    :type center: collections.abc.Sequence[float] | fakemathutils.Vector | None
    :param axis: Axis, Axis in global view space
    :type axis: collections.abc.Sequence[float] | fakemathutils.Vector | None
    """
...
def select_axis(
    ...
    undo: bool | None = None,
    *,
    orientation: fakebpy.typing.TransformOrientationItems | None = "LOCAL",
    sign: typing.Literal["POS", "NEG", "ALIGN"] | None = "POS",
    axis: fakebpy.typing.AxisXyzItems | None = "X",
    threshold: float | None = 0.0001,
):
    ...
    :type orientation: fakebpy.typing.TransformOrientationItems | None
    ...
    :type axis: fakebpy.typing.AxisXyzItems | None
...
def select_linked(
    ...
    undo: bool | None = None,
    *,
    delimit: set[fakebpy.typing.MeshDelimitModeItems] | None = {"SEAM"},
):
...
def select_mirror(
    ...
    undo: bool | None = None,
    *,
    axis: set[fakebpy.typing.AxisFlagXyzItems] | None = {"X"},
    extend: bool | None = False,
):
    ...
    :type undo: bool | None
    :param axis: Axis
    :type axis: set[fakebpy.typing.AxisFlagXyzItems] | None
...
def select_mode(
    ...
    *,
    ...
    type: fakebpy.typing.MeshSelectModeItems | None = "VERT",
    ...
    """Change selection mode
        ...
        :param type: Type
        :type type: fakebpy.typing.MeshSelectModeItems | None
        :param action: Action, Selection action to execute
...
def shortest_path_pick(
    ...
    undo: bool | None = None,
    *,
    edge_mode: typing.Literal["SELECT", "SEAM", "SHARP", "CREASE", "BEVEL", "fakefreestyle"]
    | None = "SELECT",
    ...
    :type edge_mode: typing.Literal['SELECT','SEAM','SHARP','CREASE','BEVEL','fakefreestyle'] | None
...
def symmetrize(
    ...
    undo: bool | None = None,
    *,
    direction: fakebpy.typing.SymmetrizeDirectionItems | None = "NEGATIVE_X",
    threshold: float | None = 0.0001,
):
    ...
    :type direction: fakebpy.typing.SymmetrizeDirectionItems | None
