...
def duplicate_move(
    ...
    *,
    ...
    TRANSFORM_OT_seq_slide: fakebpy.ops.transform.seq_slide | None = None,
):
    ...
    :type TRANSFORM_OT_seq_slide: fakebpy.ops.transform.seq_slide | None
    """
...
def effect_strip_add(
    ...
    *,
    ...
    color: collections.abc.Sequence[float] | fakemathutils.Color | None = (0.0, 0.0, 0.0),
):
    ...
    Color Mix.
        ...
        :type color: collections.abc.Sequence[float] | fakemathutils.Color | None
    """
...
def strip_color_tag_set(
    ...
    undo: bool | None = None,
    *,
    color: fakebpy.typing.StripColorItems | None = "NONE",
):
    ...
    :type color: fakebpy.typing.StripColorItems | None
    """
