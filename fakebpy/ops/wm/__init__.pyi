...
def alembic_export(
    ...
    *,
    ...
    quad_method: fakebpy.typing.ModifierTriangulateQuadMethodItems
...
def batch_rename(
    ...
    *,
    ...
    actions: fakebpy.types.bpy_prop_collection[fakebl_operators.wm.BatchRenameAction]
    | None = None,
):
    ...
    :type actions: fakebpy.types.bpy_prop_collection[fakebl_operators.wm.BatchRenameAction] | None
    """
...
def operator_presets_cleanup(
    ...
    *,
    operator: str = "",
    properties: fakebpy.types.bpy_prop_collection[fakebpy.types.OperatorFileListElement]
    | None = None,
):
    ...
    :type properties: fakebpy.types.bpy_prop_collection[fakebpy.types.OperatorFileListElement] | None
    """
...
def set_stereo_3d(
    ...
    undo: bool | None = None,
    *,
    display_mode: fakebpy.typing.Stereo3DDisplayItems | None = "ANAGLYPH",
    anaglyph_type: fakebpy.typing.Stereo3DAnaglyphTypeItems | None = "RED_CYAN",
    interlace_type: fakebpy.typing.Stereo3DInterlaceTypeItems | None = "ROW_INTERLEAVED",
    ...
    :type display_mode: fakebpy.typing.Stereo3DDisplayItems | None
    :param anaglyph_type: Anaglyph Type
    :type anaglyph_type: fakebpy.typing.Stereo3DAnaglyphTypeItems | None
    :param interlace_type: Interlace Type
    :type interlace_type: fakebpy.typing.Stereo3DInterlaceTypeItems | None
...
def xr_navigation_fly(
    ...
    *,
    ...
    speed_interpolation0: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        0.0,
        0.0,
    ),
    speed_interpolation1: collections.abc.Sequence[float] | fakemathutils.Vector | None = (
        1.0,
        1.0,
    ),
):
    ...
    Controller Forward -- Move along controller's forward axis.
        ...
        :type speed_interpolation0: collections.abc.Sequence[float] | fakemathutils.Vector | None
        :param speed_interpolation1: Speed Interpolation 1, Second cubic spline control point between min/max speeds
        :type speed_interpolation1: collections.abc.Sequence[float] | fakemathutils.Vector | None
    """
...
def xr_navigation_teleport(
    ...
    *,
    ...
    axis: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0, -1.0),
