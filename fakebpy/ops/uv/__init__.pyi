...
def randomize_uv_transform(
    ...
    *,
    ...
    loc: collections.abc.Sequence[float] | fakemathutils.Vector | None = (0.0, 0.0),
...
def select_mode(
    ...
    undo: bool | None = None,
    *,
    type: fakebpy.typing.MeshSelectModeUvItems | None = "VERTEX",
):
    ...
    :type undo: bool | None
    :param type: Type
    :type type: fakebpy.typing.MeshSelectModeUvItems | None
    """
...
def stitch(
    ...
    *,
    ...
    selection: fakebpy.types.bpy_prop_collection[fakebpy.types.SelectedUvElement] | None = None,
    ...
    :type selection: fakebpy.types.bpy_prop_collection[fakebpy.types.SelectedUvElement] | None
