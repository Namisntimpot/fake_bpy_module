...
fakebpy.app.handlers.rst
fakebpy.app.translations.rst
fakebpy.app.icons.rst
fakebpy.app.timers.rst
...
def is_job_running(job_type: fakebpy.typing.WmJobTypeItems):
    """Check whether a job of the given type is running.

    :param job_type: job type in `rna_enum_wm_job_type_items`.
    :type job_type: fakebpy.typing.WmJobTypeItems
    :return: Whether a job of the given type is currently running.
    """

alembic: typing.Any
""" Constant value fakebpy.app.alembic(supported=True, version=(1, 8, 3), version_string=' 1,  8,  3')
"""
...
ffmpeg: typing.Any
""" Constant value fakebpy.app.ffmpeg(supported=True, avcodec_version=(60, 31, 102), avcodec_version_string='60, 31, 102', avdevice_version=(60, 3, 100), avdevice_version_string='60,  3, 100', avformat_version=(60, 16, 100), avformat_version_string='60, 16, 100', avutil_version=(58, 29, 100), avutil_version_string='58, 29, 100', swscale_version=(7, 5, 100), swscale_version_string=' 7,  5, 100')
"""

ocio: typing.Any
""" Constant value fakebpy.app.ocio(supported=True, version=(2, 3, 2), version_string=' 2,  3,  2')
"""

oiio: typing.Any
""" Constant value fakebpy.app.oiio(supported=True, version=(2, 5, 11), version_string=' 2,  5, 11')
"""
...
""" Constant value fakebpy.app.opensubdiv(supported=True, version=(3, 6, 0), version_string=' 3,  6,  0')
"""

openvdb: typing.Any
""" Constant value fakebpy.app.openvdb(supported=True, version=(11, 0, 0), version_string='11,  0,  0')
"""
...
sdl: typing.Any
""" Constant value fakebpy.app.sdl(supported=True, version=(0, 0, 0), version_string='Unknown', available=False)
"""
...
usd: typing.Any
""" Constant value fakebpy.app.usd(supported=True, version=(0, 24, 5), version_string=' 0, 24,  5')
"""
...
""" The Blender version, as a tuple, last used to save a .blend file, compatible with fakebpy.data.version. This value should be used for handling compatibility changes between Blender versions
"""
