...
Then, call fakebpy.app.translations.register(__name__, your_dict)

 in your register()

 function, and
fakebpy.app.translations.unregister(__name__)
...
```../examples/fakebpy.app.translations.py```
