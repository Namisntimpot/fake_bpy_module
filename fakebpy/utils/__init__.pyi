...
fakebpy.utils.previews.rst
fakebpy.utils.units.rst
...
def register_class(cls):
    ...
    `fakebpy.types.Panel`, `fakebpy.types.UIList`,
    `fakebpy.types.Menu`, `fakebpy.types.Header`,
    `fakebpy.types.Operator`, `fakebpy.types.KeyingSetInfo`,
    `fakebpy.types.RenderEngine`, `fakebpy.types.AssetShelf`,
    `fakebpy.types.FileHandler`
    """
...
def resource_path(
    type: str, major: int = fakebpy.app.version[0], minor: str = fakebpy.app.version[1]
) -> str:
...
def unregister_class(cls):
    ...
    see `fakebpy.utils.register_class` for classes which can
    be registered.
    """
