...
def BoolProperty(
    *,
    ...
    default=False,
    options: set[fakebpy.typing.PropertyFlagItems] = {"ANIMATABLE"},
    override: set[fakebpy.typing.PropertyOverrideFlagItems] = set(),
    tags: set | None = set(),
    subtype: fakebpy.typing.PropertySubtypeNumberItems = "NONE",
    ...
    """Returns a new boolean property definition.
        ...
        :type options: set[fakebpy.typing.PropertyFlagItems]
        :param override: Enumerator in `rna_enum_property_override_flag_items`.
        :type override: set[fakebpy.typing.PropertyOverrideFlagItems]
        ...
        :type subtype: fakebpy.typing.PropertySubtypeNumberItems
...
def BoolVectorProperty(
    *,
    ...
    override: set[fakebpy.typing.PropertyOverrideFlagItems] = set(),
    tags: set | None = set(),
    subtype: fakebpy.typing.PropertySubtypeNumberArrayItems = "NONE",
    ...
    """Returns a new vector boolean property definition.
        ...
        :type subtype: fakebpy.typing.PropertySubtypeNumberArrayItems
...
def CollectionProperty(
    *,
    ...
    translation_context: str | None = "*",
    options: set[fakebpy.typing.PropertyFlagItems] = {"ANIMATABLE"},
    override: set[fakebpy.typing.PropertyOverrideFlagCollectionItems] = set(),
    tags: set | None = set(),
):
    """Returns a new collection property definition.

    :param type: A subclass of `fakebpy.types.PropertyGroup`.
    :param name: Name used in the user interface.
    :type name: str | None
    :param description: Text used for the tooltip and api documentation.
    :type description: str | None
    ...
    :type override: set[fakebpy.typing.PropertyOverrideFlagCollectionItems]
    :param tags: Enumerator of tags that are defined by parent class.
    :type tags: set | None
    """
...
def EnumProperty(
    *,
    ...
    | collections.abc.Callable[
        [typing.Any, fakebpy.types.Context | None],
    ...
    options: set[fakebpy.typing.PropertyFlagEnumItems] = {"ANIMATABLE"},
    override: set[fakebpy.typing.PropertyOverrideFlagItems] = set(),
    tags: set | None = set(),
    update: typing.Any | None = None,
    get: typing.Any | None = None,
    ...
    (e.g. returned by `fakebpy.types.UILayout.icon`)
    ...
    will misbehave or even crash.
        :type items: collections.abc.Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, str, int] | None] | collections.abc.Callable[[typing.Any, fakebpy.types.Context | None], collections.abc.Iterable[tuple[str, str, str] | tuple[str, str, str, int] | tuple[str, str, str, str, int] | None]]
        :param name: Name used in the user interface.
        :type name: str | None
        :param description: Text used for the tooltip and api documentation.
        :type description: str | None
    ...
    (i.e. if a callback function is given as items parameter).
        ...
        :type options: set[fakebpy.typing.PropertyFlagEnumItems]
        :param override: Enumerator in `rna_enum_property_override_flag_items`.
        :type override: set[fakebpy.typing.PropertyOverrideFlagItems]
        :param tags: Enumerator of tags that are defined by parent class.
        :type tags: set | None
...
def FloatProperty(
    *,
    ...
    tags: set | None = set(),
    subtype: fakebpy.typing.PropertySubtypeNumberItems = "NONE",
    unit: fakebpy.typing.PropertyUnitItems = "NONE",
    update: typing.Any | None = None,
    get: typing.Any | None = None,
    set: typing.Any | None = None,
):
    """Returns a new float (single precision) property definition.
        ...
        :type unit: fakebpy.typing.PropertyUnitItems
        :param update: Function to be called when this value is modified,
    This function must take 2 values (self, context) and return None.
    Warning there are no safety checks to avoid infinite recursion.
        :type update: typing.Any | None
...
def PointerProperty(
    *,
    ...
    """Returns a new pointer property definition.
        ...
        :param type: A subclass of `fakebpy.types.PropertyGroup` or `fakebpy.types.ID`.
        :param name: Name used in the user interface.
        :type name: str | None
        :param description: Text used for the tooltip and api documentation.
        :type description: str | None
...
def StringProperty(
    *,
    ...
    override: set[fakebpy.typing.PropertyOverrideFlagItems] = set(),
    tags: set | None = set(),
    subtype: fakebpy.typing.PropertySubtypeStringItems = "NONE",
    update: typing.Any | None = None,
    get: typing.Any | None = None,
    set: typing.Any | None = None,
    ...
    """Returns a new string property definition.
        ...
        :type subtype: fakebpy.typing.PropertySubtypeStringItems
        :param update: Function to be called when this value is modified,
    This function must take 2 values (self, context) and return None.
    Warning there are no safety checks to avoid infinite recursion.
        :type update: typing.Any | None
