...
import fakebpy_extras.io_utils
import fakebpy_extras.object_utils

class IMAGE_OT_convert_to_mesh_plane(
    TextureProperties_MixIn, MaterialProperties_MixIn, fakebpy.types.Operator
):
...
class IMAGE_OT_import_as_mesh_planes(
    ...
    fakebpy_extras.io_utils.ImportHelper,
    fakebpy_extras.object_utils.AddObjectHelper,
    MaterialProperties_MixIn,
    fakebpy.types.Operator,
):
...
def load_images(
    ...
    """Wrapper for fakebpy_extras.image_utils.load_image.Loads a set of images, movies, or even image sequences
