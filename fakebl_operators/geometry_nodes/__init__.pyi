...
class MoveModifierToNodes(fakebpy.types.Operator):
...
class NewGeometryNodeGroupTool(fakebpy.types.Operator):
...
class NewGeometryNodeTreeAssign(fakebpy.types.Operator):
...
class NewGeometryNodesModifier(fakebpy.types.Operator):
