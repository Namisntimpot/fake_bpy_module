...
class SequencerCrossfadeSounds(fakebpy.types.Operator):
...
class SequencerDeinterlaceSelectedMovies(fakebpy.types.Operator):
...
class SequencerFadesAdd(fakebpy.types.Operator):
...
class SequencerFadesClear(fakebpy.types.Operator):
...
class SequencerSplitMulticam(fakebpy.types.Operator):
...
class SEQUENCER_FH_image_strip(fakebpy.types.FileHandler, SequencerFileHandlerBase):
...
class SEQUENCER_FH_movie_strip(fakebpy.types.FileHandler, SequencerFileHandlerBase):
    bl_file_extensions: typing.Any
    bl_idname: typing.Any
    bl_import_operator: typing.Any
    bl_label: typing.Any
...
class SEQUENCER_FH_sound_strip(fakebpy.types.FileHandler, SequencerFileHandlerBase):
    bl_file_extensions: typing.Any
    bl_idname: typing.Any
    bl_import_operator: typing.Any
    bl_label: typing.Any
