...
class AlignUVRotation(fakebpy.types.Operator):
...
class RandomizeUVTransform(fakebpy.types.Operator):
...
def is_face_uv_selected(face: fakebmesh.types.BMFace, uv_layer, any_edge: bool) -> bool:
