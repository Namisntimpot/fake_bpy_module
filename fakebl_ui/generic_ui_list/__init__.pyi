...
class UILIST_OT_entry_add(GenericUIListOperator, fakebpy.types.Operator):
...
class UILIST_OT_entry_move(GenericUIListOperator, fakebpy.types.Operator):
...
class UILIST_OT_entry_remove(GenericUIListOperator, fakebpy.types.Operator):
...
def draw_ui_list(
    ...
    **kwargs,
    ...
    """Draw a UIList with Add/Remove/Move buttons and a menu.Additional keyword arguments are passed to `UIList.template_list`.
        ...
        :type layout: fakebpy.types.UILayout
