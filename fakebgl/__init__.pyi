...
Use the graphics API independent fakegpu module instead.

This module wraps OpenGL constants and functions, making them available from
within Blender Python.

The complete list can be retrieved from the module itself, by listing its
contents: dir(fakebgl).  A simple search on the web can point to more
...
[NOTE]
You can use the fakebpy.types.Image type to load and set textures.
See fakebpy.types.Image.gl_load and fakebpy.types.Image.gl_free,
for example.
...
class Buffer:
    ...
    notation is used in the OpenGL functions the Buffer object can be used in it's fakebgl
    ...
    def __init__(self, type: int, dimensions, template=None):
        """This will create a new Buffer object for use with other fakebgl OpenGL commands.
