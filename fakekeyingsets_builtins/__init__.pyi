...
class BUILTIN_KSI_Available(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_BendyBones(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_DeltaLocation(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_DeltaRotation(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_DeltaScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_LocRot(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_LocRotScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_LocRotScaleCProp(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_LocScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_Location(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_RotScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_Rotation(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_Scaling(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualLoc(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualLocRot(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualLocRotScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualLocScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualRot(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualRotScale(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_VisualScaling(fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_WholeCharacter(WholeCharacterMixin, fakebpy.types.KeyingSetInfo):
...
class BUILTIN_KSI_WholeCharacterSelected(WholeCharacterMixin, fakebpy.types.KeyingSetInfo):
