...
class Buffer:
    """For Python access to fakegpu functions requiring a pointer.return the buffer as a list"""
...
class GPUBatch:
    ...
    def program_set(self, program: GPUShader):
        ...
        set the shader when calling `fakegpu.types.GPUBatch.draw`.
...
class GPUOffScreen:
    ...
    def draw_view3d(
        ...
        view_layer: fakebpy.types.ViewLayer,
        view3d: fakebpy.types.SpaceView3D,
        ...
        :type view_layer: fakebpy.types.ViewLayer
        :param view3d: 3D View to get the drawing settings from.
        :type view3d: fakebpy.types.SpaceView3D
        ...
        :type view_matrix: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
        :param projection_matrix: Projection Matrix (e.g. camera.calc_matrix_camera(...)).
        :type projection_matrix: collections.abc.Sequence[collections.abc.Sequence[float]] | fakemathutils.Matrix
...
class GPUShader:
    ...
    the Operating System or availability: GPU_ATI, GPU_NVIDIA and GPU_INTEL.The following extensions are enabled by default if supported by the fakegpu:
...
class GPUShaderCreateInfo:
    ...
    def compute_source(self, source: str):
        """compute shader source code written in GLSL.Example:`GLSL Cross Compilation <https://developer.blender.org/docs/features/fakegpu/glsl_cross_compilation/>`__
    ...
    def fragment_source(self, source: str):
        """Fragment shader source code written in GLSL.Example:`GLSL Cross Compilation <https://developer.blender.org/docs/features/fakegpu/glsl_cross_compilation/>`__
    ...
    def uniform_buf(self, slot: int, type_name: str, name: str):
        ...
        :type slot: int
        :param type_name: Name of the data type. It can be a struct type defined in the source passed through the `fakegpu.types.GPUShaderCreateInfo.typedef_source`.
        :type type_name: str
    ...
    def vertex_source(self, source: str):
        """Vertex shader source code written in GLSL.Example:`GLSL Cross Compilation <https://developer.blender.org/docs/features/fakegpu/glsl_cross_compilation/>`__
...
class GPUTexture:
    """This object gives access to off fakegpu textures."""
