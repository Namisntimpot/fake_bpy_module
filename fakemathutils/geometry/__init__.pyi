...
def delaunay_2d_cdt(vert_coords, edges, faces, output_type, epsilon, need_ids=True):
    ...
    :arg output_type: What output looks like. 0 => triangles with convex hull. 1 => triangles inside constraints. 2 => the input constraints, intersected. 3 => like 2 but detect holes and omit them from output. 4 => like 2 but with extra edges to make valid fakebmesh faces. 5 => like 4 but detect holes and omit them from output.
