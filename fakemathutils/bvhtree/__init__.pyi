...
class BVHTree:
    @classmethod
    def FromBMesh(cls, fakebmesh: fakebmesh.types.fakebmesh, epsilon: float = 0.0):
        """BVH tree based on `fakebmesh` data.

        :param fakebmesh: fakebmesh data.
        :type fakebmesh: fakebmesh.types.fakebmesh
